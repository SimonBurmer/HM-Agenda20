...
public class TopicController extends AbstractController {
	...
	public String getTaskUnRegistrationView(Model model, Authentication auth, @PathVariable("uuid") String uuid) {
		SubscriberTopicDto topic = topicService.getTopic(uuid, auth.getName());
		model.addAttribute("topic", topic);
	...
	public String handleTaskUnRegistration(Model model, Authentication auth, @PathVariable("uuid") String uuid,
	...
	public String handelUpdateTopic(@ModelAttribute("topic") OwnerTopicDto topic, @PathVariable("uuid") String uuid,
